      ...
      <div className="bg-linear-to-r from-[#A7D7C5]/30 to-[#A2C4C9]/30 rounded-3xl p-6 sm:p-8 border border-[#74B49B]/30 flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div className="space-y-2 max-w-2xl">
          ...
          <h1 className="text-3xl sm:text-4xl font-extrabold text-slate-800 tracking-tight">
            Peer &amp; Mentor <span className="text-[#5C899D]">Knowledge Network</span>
          </h1>
            ...
            return (
              ...
              >
                ...
                <button
                  ...
                  className={`flex sm:flex-col items-center gap-1.5 px-3 py-2 sm:px-3 sm:py-2.5 rounded-2xl border transition shrink-0 ${
                    isUpvoted
                ...
                <div className="space-y-2 flex-1 min-w-0">
                  ...
                  <div className="flex flex-wrap items-center justify-between gap-3 pt-2">
                    ...
                    <div className="flex items-center gap-4 text-xs text-slate-500">
                      ...
                      >
                        <MessageCircle className="w-3.5 h-3.5" /> {post.answers_count} Answers
                      </Link>
                    </div>
                  </div>
                </div>
            ...
            <form onSubmit={handleCreatePost} className="space-y-3.5 text-xs">
              ...
              <div className="flex justify-end gap-2 pt-2 border-t border-slate-100">
                ...
                <button
                  type="submit"
                  disabled={submitting}
                  className="inline-flex items-center gap-1.5 px-4 py-2 bg-[#74B49B] text-white font-semibold rounded-xl shadow-xs"
                >
